...
class Module:
    ...
    def train(self) -> None:
        ...
        def _set_training(module: Module) -> None:
    ...
    def eval(self) -> None:
        ...
        def _set_eval(module: Module) -> None:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        def _named_parameters(module: Module, prefix: str = "") -> Generator:
    ...
    def parameters(self) -> Sequence[Parameter]:
        ...
        def _parameters(module: Module) -> Generator:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Returns the forward of whatever the input was."""
